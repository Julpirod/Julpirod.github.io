...
<article class="viewn v_static">
  <div class="in_bg">
		<header><h1>[registration]Регистрация нового пользователя[/registration]
    [validation]Обновление профиля пользователя[/validation]</h1></header>
    ...
    [registration]
      <tr>
        ...
        <td>
          <input type="text" name="name" id='name' style="width:175px; margin-right: 6px;" class="f_input" /><input class="bbcodes" style="font-size: 14px;" title="Проверить доступность логина для регистрации" onClick="CheckLogin(); return false;" type="button" value="Проверить имя" />
